...
<html lang="en">
    ...
    <body>
        <h1 style="text-align: center"><strong style="font-family: '標楷體'; font-size: 30pt;">每日飲食調查表</strong>
		</h1><br>
		<h2 style="font-family: '標楷體'; font-size: 19pt;">治療幽門螺旋桿菌時，宜避開食物：</h2><br>

		@if($errors->has('Sour_Fruit_Juice'))
			<div calss="required" style="font-family: '標楷體';">
		...
		<ol>
			<li style="font-family: '標楷體'; font-size: 14pt;">
				<label style="font-family: '標楷體'; font-size: 14pt;">酸的水果及果汁：</label><br>
			...
			<li style="font-family: '標楷體'; font-size: 14pt;">
				<label style="font-family: '標楷體'; font-size: 14pt;">酸的食物及調味料：</label><br>
			...
			<li style="font-family: '標楷體'; font-size: 14pt;">
				<label style="font-family: '標楷體'; font-size: 14pt;">甜食：</label><br>
			...
			<li style="font-family: '標楷體'; font-size: 14pt;">
				<label style="font-family: '標楷體'; font-size: 14pt;">飲料：</label><br>
			...
			<li style="font-family: '標楷體'; font-size: 14pt;">
				<label style="font-family: '標楷體'; font-size: 14pt;">辣的食物及調味料：</label><br>
			...
			<li style="font-family: '標楷體'; font-size: 14pt;">
				<label style="font-family: '標楷體'; font-size: 14pt;">乳製品：</label><br>
			...
			<li style="font-family: '標楷體'; font-size: 14pt;">
				<label style="font-family: '標楷體'; font-size: 14pt;">成份複雜或不清楚的健康食品(若沒有請填無)：</label><br>
