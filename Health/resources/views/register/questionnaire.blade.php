...
<body>
<h1 style="text-align: center"><strong style="font-family: '標楷體'; font-size: 30pt;">問卷調查表</strong>
</h1><br>
...
<ol>
<p style="font-family: '標楷體'; font-size: 18pt;">基本資料 </p>
	<li>
	
		<label  style="font-family: '標楷體'; font-size: 14pt;">姓名：</label>
  		{{Form::text('name')}}
	</li>
	<li>
  		<label  style="font-family: '標楷體'; font-size: 14pt;">身分證字號：</label>
  		{{Form::text('user_ID')}}
	</li>
	<li>
		<label  style="font-family: '標楷體'; font-size: 14pt;">出生年月日：</label>
    	{{Form::text('password')}}
    	<label style="font-family: '標楷體'; font-size: 14pt;">例如2000年10月10日，請輸入20001010</label>
  	</li>
		
  <li>
	<label style="font-family: '標楷體'; font-size: 14pt;">身高：</label>
    	{{Form::text('height')}}
    <label style="font-family: '標楷體'; font-size: 14pt;">公分；</label>
    <label style="font-family: '標楷體'; font-size: 14pt;">體重：</label>
    	{{Form::text('weight')}}
    <label style="font-family: '標楷體'; font-size: 14pt;">公斤</label>
  </li>
  <li>
	<label style="font-family: '標楷體'; font-size: 14pt;">性別：</label>
		{{Form::select('gender',['男'=>'男','女'=>'女'])}}
  </li>
  
  <li>
	<label style="font-family: '標楷體'; font-size: 14pt;">血型：</label>
		{{Form::select('blood_type',['O'=>'O','A'=>'A','B'=>'B','AB'=>'AB','unknown'=>'未知'])}}
  </li>
  <li>
	<label style="font-family: '標楷體'; font-size: 14pt;">教育程度：</label>
		{{Form::select('education_level',['小學'=>'小學','國中'=>'國中','高中職'=>'高中職','大學'=>'大學','研究所以上'=>'研究所以上'])}}
  </li>
   <li>
	<label style="font-family: '標楷體'; font-size: 14pt;">職業：</label>
    	{{Form::text('occupation')}}
  </li>
  <li>
	<label for="degree" style="font-family: '標楷體'; font-size: 14pt;">婚姻狀況：</label>
		{{Form::select('marital_status',['未婚'=>'未婚','已婚'=>'已婚','再婚'=>'再婚','離婚'=>'離婚','喪偶'=>'喪偶'])}}
  </li>
  <li>
	<label for="degree" style="font-family: '標楷體'; font-size: 14pt;">本籍：</label>
		{{Form::select('native',['閩南人'=>'閩南人','客家人'=>'客家人','原住民'=>'原住民','廣東福建'=>'廣東福建','其他'=>'其他'])}}
  </li>

<p style="font-family: '標楷體'; font-size: 18pt;">生活習慣與嗜好 </p>
<p style="font-family: '標楷體'; font-size: 14pt;">＊喝酒 </p>

  <li>
	<label for="heigh" style="font-family: '標楷體'; font-size: 14pt;">您一般喝酒的習慣為何？</label>
  	<ol>
   	  <li style="font-family: '標楷體'; font-size: 12pt;">
  ...
  <li style="font-family:'標楷體';">
	<label for="hgender" style="font-family: '標楷體'; font-size: 14pt;">您幾歲開始喝酒？</label>
		{{Form::text('Drinking_Year')}}歲
  </li>
  <li style="font-family:'標楷體';">
	<label  style="font-family: '標楷體'; font-size: 14pt;">您每週約喝多少酒？</label>
		{{Form::text('Drinking_CC',0)}}CC(若從不喝請填0)
  </li>
  <li>
	<label for="heigh" style="font-family: '標楷體'; font-size: 14pt;">您較常喝的酒，酒精濃度是多少？</label>
  	<ol>
   	  <li style="font-family: '標楷體'; font-size: 12pt;">
  ...
  <p style="font-family: '標楷體'; font-size: 14pt;">＊抽菸 </p>

  <li style="font-family: '標楷體'; font-size: 14pt;">
  	<label for="" style="font-family: '標楷體'; font-size: 14pt;">您是否曾規律地抽菸超過三個月以上？</label>
	...
	<p style="font-family: '標楷體'; font-size: 14pt;">＊嚼檳榔 </p>

	<li style="font-family: '標楷體'; font-size: 14pt;">
  	<label for="" style="font-family: '標楷體'; font-size: 14pt;">您是否曾規律地嚼檳榔超過三個月以上？</label>
...
<p style="font-family: '標楷體'; font-size: 14pt;">＊喝茶 </p>

	<li style="font-family: '標楷體'; font-size: 14pt;">
  	<label for="" style="font-family: '標楷體'; font-size: 14pt;">您是否曾經有幾乎每天喝茶，而且維持三個月或更久？</label>
...
<p style="font-family: '標楷體'; font-size: 14pt;">＊喝咖啡</p>

	<li style="font-family: '標楷體'; font-size: 14pt;">
  	<label for="" style="font-family: '標楷體'; font-size: 14pt;">您是否曾經規律地喝咖啡一週一次以上，而且維持三個月或更久？</label>
...
<p style="font-family: '標楷體'; font-size: 14pt;">＊常吃的食物</p>
	<li style="font-family: '標楷體'; font-size: 14pt;">
	<label style="font-family: '標楷體'; font-size: 14pt;">您是否常吃下列食物：(每週大於等於3次)</label>
		<ol>
			<li  style="font-family: '標楷體'; font-size: 12pt;">
  				<label >酸的食物</label>
...
<p style="font-family: '標楷體'; font-size: 14pt;">＊睡眠與生活</p>
	<li style="font-family: '標楷體'; font-size: 14pt;">
		<label style="font-family: '標楷體'; font-size: 14pt;">您每天睡幾小時：(平均值)</label>
		...
		<label style="font-family: '標楷體'; font-size: 14pt;">您是否有下列感覺？請依自感程度點選</label>
		<ol>
			<li  style="font-family: '標楷體'; font-size: 12pt;">
	...
	<p style="font-family: '標楷體'; font-size: 18pt;">過去疾病史</p>
	<li style="font-family: '標楷體'; font-size: 14pt;">
		<label style="font-family: '標楷體'; font-size: 14pt;">請問您是否曾罹患下列何種疾病？</label>
...
<p style="font-family: '標楷體'; font-size: 18pt;">藥物史</p>
	<li style="font-family: '標楷體'; font-size: 14pt;">
		<label style="font-family: '標楷體'; font-size: 14pt;">您服用下列何種藥物？服用時間多久？</label>
	...
	<p style="font-family: '標楷體'; font-size: 18pt;"></p>
	<li style="font-family: '標楷體'; font-size: 14pt;">
		<label style="font-family: '標楷體'; font-size: 14pt;">＊女性請多答23題</label>
		<ol>
			<li  style="font-family: '標楷體'; font-size: 12pt;">
	...
	<p style="font-family: '標楷體'; font-size: 18pt;">家族疾病史</p>
	<li style="font-family: '標楷體'; font-size: 14pt;">
		<label style="font-family: '標楷體'; font-size: 14pt;">請問您的親人中是否有人曾罹患下列的腸胃疾病？</label>
		<ol>
			<li  style="font-family: '標楷體'; font-size: 12pt;">
				<label>慢性胃炎</label>
  			...
  			<li style="font-family: '標楷體'; font-size: 12pt;">
				<label style="font-family: '標楷體'; font-size: 14pt;">家族成員包括：</label><br>
				{{Form::textarea('Family','兄長')}}
			</li>	
		</ol>
	</li>

	<p style="font-family: '標楷體'; font-size: 18pt;">症狀</p>
	<li style="font-family: '標楷體'; font-size: 14pt;">
		<label style="font-family: '標楷體'; font-size: 14pt;">您最近有無下列症狀？</label>
		<ol>
			<li  style="font-family: '標楷體'; font-size: 12pt;">
				<label>上腹痛</label>
	...
	<p style="font-family: '標楷體'; font-size: 18pt;">細菌檢驗及抗生素使用經驗</p>
	<li style="font-family: '標楷體'; font-size: 14pt;">
		<label style="font-family: '標楷體'; font-size: 14pt;">請您回下列問題</label>
		<ol>
			<li  style="font-family: '標楷體'; font-size: 12pt;">
