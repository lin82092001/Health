...
<head>
    ...
    form {font-size:20px; color:#000; font-weight: bold;font-family: '標楷體';}
    form {width:170px; margin:20px auto; padding: 10px; border:2px dotted #ccc;}
    form input[type="text"], form input[type="password"] {margin: 2px 0 20px; color:#000;}
    form input[type="submit"] {width: 100%; height: 30px; color:#000; font-size:16pt;font-family: '標楷體';}
    </style>
</head>
<body>
