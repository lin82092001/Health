...
<head>
	...
	<style>
		form input[type="submit"],form input[type="text"]{color:#000; font-size:24pt;font-family: '標楷體';}
		.required {font-size:24px;width:320px; margin: 20px auto; color: red;}
		form {font-size:24px; color:#000;font-family: '標楷體';}
		select{
    		font-size: 24px;
    		padding: 5px;
		}
